---
name: secretary-route
description: Map user intent to Cursor roles after the turn brief. Use when choosing builder, reviewer, or other roles; run adaptive-lifecycle when lifecycle_plan is empty.
---
